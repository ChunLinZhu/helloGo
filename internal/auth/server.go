// Package auth — Auth Service gRPC 服务器
package auth
...
// Server 管理 Auth Service gRPC 服务器生命周期
type Server struct {
...
// NewServer 创建 Auth Service gRPC 服务器
...
func (s *Server) Run() error {
	...
	s.logger.Info("Auth Service gRPC 服务器已启动", zap.Int("port", s.port))
