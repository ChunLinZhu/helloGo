// Package user — User Service gRPC 服务器
package user
...
// Server 管理 User Service gRPC 服务器生命周期
type Server struct {
...
// NewServer 创建 User Service gRPC 服务器
...
func (s *Server) Run() error {
	...
	s.logger.Info("User Service gRPC 服务器已启动", zap.Int("port", s.port))
